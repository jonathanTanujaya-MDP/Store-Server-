-- SETUP UNTUK DATABASE manajemen_stock
-- Jalankan: psql -U stock_user -d manajemen_stock
...
-- Verifikasi
SELECT 'Tables created successfully in manajemen_stock database!' as status;
\dt
