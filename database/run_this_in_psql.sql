-- INSTRUKSI MENJALANKAN DATABASE SETUP
-- 
-- 1. MASUK KE PostgreSQL:
--    psql -U [username] -d [database_name]
--    
-- 2. ATAU jika belum ada database, buat dulu:
--    createdb manajemen_stock
--    psql -U postgres -d manajemen_stock
--
-- 3. COPY dan PASTE script di bawah ini ke psql terminal:
...
-- Drop existing tables if needed (HATI-HATI: INI AKAN MENGHAPUS DATA!)
-- DROP TABLE IF EXISTS stock_movements CASCADE;
-- DROP TABLE IF EXISTS sales_items CASCADE;
-- DROP TABLE IF EXISTS sales_transactions CASCADE;
-- DROP TABLE IF EXISTS restock_items CASCADE;
-- DROP TABLE IF EXISTS restock_transactions CASCADE;
...
-- ============================================
-- SAMPLE DATA (Optional - Uncomment jika ingin sample data)
-- ============================================
...
-- Jalankan query ini untuk memeriksa tabel yang sudah dibuat:
-- \dt
